 ...
 *
 *GradeBookArray class using an array to store test grades.
...
public class GradeBookArray {
	...
	private String courseName; // name of course this GradeBookArray represents
	...
	} // end two-argument GradeBookArray constructor
	...
	// display a welcome message to the GradeBookArray user
	public void displayMessage() {
	     // getCourseName gets the name of the course
		System.out.printf("Welcome to the GradeBookArray for \n%s!\n\n", 
		getCourseName() );
	...
	public int getMaximum() {
		...
		int hightGrade = grades[0]; // assume grades[ 0 ] is largest
		 // loop through grades array
		for(int grade : grades) {
		     // if grade greater than highGrade, assign it to highGrade
			if(grade > hightGrade)
			 
			hightGrade = grade; // new highest grade
		} // end for
		return hightGrade; // return highest grade
	...
	public void outputBarChart() {
		...
		System.out.println("Grade distribustion:");
